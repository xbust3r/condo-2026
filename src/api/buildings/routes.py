...
from library.dddpy.core_buildings.usecase import create_buildings_usecase
...
def create_building(schema: CreateBuildingsCmdSchema):
...
def update_building(building_id: int, schema: UpdateBuildingsCmdSchema):
    usecase = create_buildings_usecase()
    try:
