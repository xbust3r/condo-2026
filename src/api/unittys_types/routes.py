...
from library.dddpy.core_unittys_types.usecase import create_unittys_types_usecase
...
def create_unit_type(schema: CreateUnittysTypesCmdSchema):
...
def update_unit_type(type_id: int, schema: UpdateUnittysTypesCmdSchema):
    usecase = create_unittys_types_usecase()
    try:
