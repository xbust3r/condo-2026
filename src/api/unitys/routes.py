...
from library.dddpy.core_unitys.usecase import create_unitys_usecase
...
def create_unity(schema: CreateUnitysCmdSchema):
...
def update_unity(unity_id: int, schema: UpdateUnitysCmdSchema):
    usecase = create_unitys_usecase()
    try:
