...
from library.dddpy.users_residents.usecase import create_residents_usecase
...
def create_resident(schema: CreateResidentsCmdSchema):
...
def update_resident(resident_id: int, schema: UpdateResidentsCmdSchema):
    usecase = create_residents_usecase()
    try:
