...
class DBVote(Base):
    ...
    scope_type = Column(String(20), nullable=False, server_default='condominium', comment="CONDOMINIUM or BUILDING")
    vote_calculation_type = Column(String(20), nullable=False, server_default='by_unit', comment="by_unit or by_coefficient")
    building_id = Column(BigInteger, nullable=True, comment="FK core_buildings.id — set when scope_type=BUILDING")
